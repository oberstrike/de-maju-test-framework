...
import de.maju.util.put

interface IKeycloakDefaultHandler :
    IOnConfigCreatedHandler<KeycloakContainer>,
    IOnContainerCreatedHandler<KeycloakContainer>

class KeycloakDefaultHandler(
    keycloakContainerConfig: IKeycloakContainerConfig
) : IKeycloakDefaultHandler {
